...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.product.create', compact('distributors'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.product.edit', compact('product', 'distributors', 'selectedDistributors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.product.index')->with('success', 'Data produk berhasil disimpan');
