    ...
    public static function data(): array
    {
        ...
        foreach ($distributors as $index => $name) {
            ...
            $rows[] = [
                ...
                'business_scale_code' => $businessScale,
    ...
    public function run(): void
    {
        ...
        foreach (self::data() as $row) {
            $rows[] = [
                ...
                'phone' => $row['phone'],
                'email' => $row['email'],
                'payment_term_id' => $paymentTerms[$row['payment_term_code']] ?? null,
                'delivery_method_id' => $deliveryMethods[$row['delivery_method_code']] ?? null,
                'business_scale_id' => $businessScales[$row['business_scale_code']] ?? null,
