...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ $criteria->import_batch_id ? route('import.excel.history') : route('criteria.index') }}" class="btn btn-secondary btn-sm">
            ...
            <div class="card shadow border-0">
                <div class="card-header bg-gradient-warning text-white py-3">
                    <h5 class="mb-0 font-weight-bold">
                        <i class="fas fa-edit mr-2"></i>Edit Data Kriteria
                    </h5>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="text-muted" id="weightPercentage">{{ round($criteria->weight * 100) }}%</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('attribute_type') is-invalid @enderror" 
                                        ...
                                        <option value="Benefit" {{ old('attribute_type', $criteria->attribute_type) == 'Benefit' ? 'selected' : '' }}>Benefit</option>
                                        <option value="Cost" {{ old('attribute_type', $criteria->attribute_type) == 'Cost' ? 'selected' : '' }}>Cost</option>
                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div id="codePreview" class="text-primary font-weight-bold mt-1">
                                                    {{ old('code', $criteria->code) ?: '-' }}
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <strong>Nama:</strong>
                                                <div id="namePreview" class="text-dark mt-1">
                                                    {{ old('name', $criteria->name) ?: '-' }}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <strong>Bobot:</strong>
                                                <div id="weightPreview" class="text-warning font-weight-bold mt-1">
                                                    @if(old('weight', $criteria->weight))
                                                        {{ number_format(old('weight', $criteria->weight), 2) }} ({{ round(old('weight', $criteria->weight) * 100) }}%)
                                                    @else
                                                        -
                                                    @endif
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div id="attributePreview" class="mt-1">
                                                    @if(old('attribute_type', $criteria->attribute_type) == 'Benefit')
                                                        <span class="badge badge-success">Benefit</span>
                                                    @elseif(old('attribute_type', $criteria->attribute_type) == 'Cost')
                                ...
                                <div class="card border-left-secondary">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <strong>Kode:</strong>
                                                <div class="text-dark mt-1">{{ $criteria->code }}</div>
                                            </div>
                                            <div class="col-md-3">
                                                <strong>Nama:</strong>
                                                <div class="text-dark mt-1">{{ $criteria->name }}</div>
                                            </div>
                                            <div class="col-md-2">
                                                <strong>Bobot:</strong>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="{{ $criteria->import_batch_id ? route('import.excel.history') : route('criteria.index') }}" class="btn btn-secondary btn-lg">
