...
@section('title', 'Detail Metode Pengiriman')
...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.delivery_method.index') }}" class="btn btn-secondary btn-sm">
            ...
            <div class="card shadow border-0">
                <div class="card-header bg-gradient-info text-white py-3">
                    <h5 class="mb-0 font-weight-bold">
                        <i class="fas fa-eye mr-2"></i>Detail Metode Pengiriman
                    </h5>
                </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="text-center mb-4">
                                ...
                                <h4 class="font-weight-bold text-primary">{{ $deliveryMethod->name }}</h4>
                                @if($deliveryMethod->description)
                                <p class="text-muted mb-0">{{ $deliveryMethod->description }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table table-borderless">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-dark">{{ $deliveryMethod->name }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-muted">
                                                        {{ $deliveryMethod->created_at->format('d F Y H:i') }}
                                                        <small class="text-muted">({{ $deliveryMethod->created_at->diffForHumans() }})</small>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="font-weight-bold text-dark">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{ route('admin.delivery_method.index') }}" class="btn btn-secondary btn-lg">
                                    <i class="fas fa-arrow-left mr-2"></i>Kembali
                                </a>
                                <div>
                                    @if (auth()->user()->is_admin == 1)
                                    <a href="{{ route('admin.delivery_method.edit', $deliveryMethod->id) }}" class="btn btn-primary btn-lg mr-2">
