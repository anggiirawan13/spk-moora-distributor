...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.business_scale.index') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="col-xl-8 col-lg-10">
            <div class="card shadow border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.business_scale.update', $businessScale->id) }}" method="POST" id="businessScaleForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="{{ route('admin.business_scale.index') }}" class="btn btn-secondary btn-lg">
