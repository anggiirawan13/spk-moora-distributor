                ...
                <div class="card shadow-sm border-0" style="border-radius: 15px; overflow: hidden;">
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4">
                                <form action="{{ route('admin.moora.calculation') }}" method="GET" class="d-flex align-items-end">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div>
                @if(request('product_id'))
                    <a href="{{ route('admin.moora.download_pdf', ['product_id' => request('product_id')]) }}" class="btn btn-success" style="border-radius: 10px;">
                        <i class="fas fa-file-pdf mr-2"></i>Download PDF
                    </a>
                @else
                    <a href="{{ route('admin.moora.download_pdf') }}" class="btn btn-success" style="border-radius: 10px;">
                        <i class="fas fa-file-pdf mr-2"></i>Download PDF
                    </a>
                @endif
            </div>
