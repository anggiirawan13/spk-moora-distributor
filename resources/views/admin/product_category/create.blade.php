            ...
            <div class="card shadow border-0">
                <div class="card-header bg-gradient-primary text-white py-3">
                    <h5 class="mb-0 font-weight-bold">
                        <i class="fas fa-plus-circle mr-2"></i>Tambah Kategori Produk Baru
                    </h5>
                </div>
                <div class="card-body p-4">
                    <x-alert />

                    <form action="{{ route('admin.product_category.store') }}" method="POST" id="productCategoryForm">
                        @csrf
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              id="description"
                                              rows="4" 
                                              placeholder="Masukkan deskripsi lengkap tentang kategori produk ini">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="d-flex justify-content-between align-items-center mt-1">
                                        <small class="form-text text-muted">
                                            <i class="fas fa-lightbulb mr-1"></i>Jelaskan karakteristik dan penggunaan kategori produk ini
                                        </small>
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!name) {
            ...
            Swal.fire({
                ...
                text: 'Harap masukkan nama kategori produk.',
