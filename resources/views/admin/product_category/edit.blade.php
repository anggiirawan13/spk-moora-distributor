...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-boxes text-primary mr-2"></i>Kategori Produk
        </h1>
        <a href="{{ route('admin.product_category.index') }}" class="btn btn-secondary btn-sm">
            ...
            <div class="card shadow border-0">
                <div class="card-header bg-gradient-warning text-white py-3">
                    <h5 class="mb-0 font-weight-bold">
                        <i class="fas fa-edit mr-2"></i>Edit Kategori Produk
                    </h5>
                </div>
                <div class="card-body p-4">
                    <x-alert />

                    <form action="{{ route('admin.product_category.update', $productCategory->id) }}" method="POST" id="productCategoryForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name" class="font-weight-bold text-dark mb-2">
                                        <i class="fas fa-tag text-primary mr-2"></i>Nama Kategori Produk <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" 
                                           ...
                                           placeholder="Masukkan nama kategory produk"
                                           required
                                           autofocus>
                                    @error('name')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              id="description"
                                              rows="4" 
                                              placeholder="Masukkan deskripsi lengkap tentang kategory produk ini">{{ old('description', $productCategory->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="d-flex justify-content-between align-items-center mt-1">
                                        <small class="form-text text-muted">
                                            <i class="fas fa-lightbulb mr-1"></i>Jelaskan karakteristik dan cakupan kategory produk
                                        </small>
                                        <small class="text-muted" id="charCount">{{ strlen(old('description', $productCategory->description)) }}/500 karakter</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card border-left-secondary">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <strong>Nama:</strong>
                                                <div class="text-dark mt-1">{{ $productCategory->name }}</div>
                                            </div>
                                            <div class="col-md-6">
                                                <strong>Deskripsi:</strong>
                                                <div class="text-muted mt-1 small">{{ $productCategory->description ?: '-' }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="{{ route('admin.product_category.index') }}" class="btn btn-secondary btn-lg">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!name) {
            ...
            Swal.fire({
                icon: 'warning',
                title: 'Nama Kategori Produk Kosong',
                text: 'Harap masukkan nama kategory produk.',
