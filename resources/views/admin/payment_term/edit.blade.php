...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.payment_term.index') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="col-xl-8 col-lg-10">
            <div class="card shadow border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.payment_term.update', $paymentTerm->id) }}" method="POST" id="paymentTermForm">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-1">
                                        <small class="form-text text-muted">
                                            <i class="fas fa-lightbulb mr-1"></i>Jelaskan karakteristik dan cakupan termin pembayaran
                                        </small>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="{{ route('admin.payment_term.index') }}" class="btn btn-secondary btn-lg">
