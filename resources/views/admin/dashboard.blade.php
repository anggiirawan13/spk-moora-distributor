        ...
        <div class="card border-left-primary shadow h-100 py-2" style="border-left: 4px solid #059669 !important;">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Distributor</div>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="mt-2 text-info">
                            ...
                            <span class="text-sm">Parameter Penilaian</span>
                        </div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2" style="border-left: 4px solid #3b82f6 !important;">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Alternatif</div>
                        <div class="h2 mb-0 font-weight-bold text-gray-800">{{ $data->alternative }}</div>
                        <div class="mt-2 text-primary">
                            <i class="fas fa-th mr-1"></i>
                            <span class="text-sm">Opsi Evaluasi</span>
                        </div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-lg-4 mb-4">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <h6 class="text-center text-primary font-weight-bold">SPK MOORA</h6>
