...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('subcriteria.index') }}" class="btn btn-secondary btn-sm mr-2">
    ...
    <div class="card shadow border-0">
        <div class="card-body text-center py-5">
            <div class="text-muted">
                ...
                <a href="{{ route('criteria.create') }}" class="btn btn-primary mt-3">
...
function confirmDelete(url, name) {
    ...
    if (confirm(`Anda akan menghapus sub kriteria "${name}". Tindakan ini tidak dapat dibatalkan.`)) {
        submitDelete();
    }
}
