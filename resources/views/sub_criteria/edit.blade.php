...
@php
    $backUrl = request('return_to') === 'import-approval'
        ...
        : (request('return_to') === 'import-history'
            ...
            : ($subCriteria->import_batch_id ? route('import.excel.history') : route('subcriteria.index')));
    $formAction = route('subcriteria.update', $subCriteria->id);
        ...
        <div class="col-xl-8 col-lg-10">
            <div class="card shadow border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ $formAction }}" method="POST" id="subcriteriaForm">
                        @csrf
                        @method('PUT')
