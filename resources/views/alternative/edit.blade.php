...
@php
    $backUrl = request('return_to') === 'import-approval'
        ...
        : (request('return_to') === 'import-history'
            ...
            : ($alternative->import_batch_id ? route('import.excel.history') : route('alternative.index')));
    $formAction = route('alternative.update', $alternative->id);
        ...
        <div class="col-xl-10 col-lg-12">
            <div class="card shadow border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ $formAction }}" method="POST" id="alternativeForm">
                        @csrf
                        @method('PUT')
