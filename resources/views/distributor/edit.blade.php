        ...
        <div class="col-xl-10 col-lg-12">
            <div class="card shadow border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('distributor.update', $distributor->id) }}" method="POST" enctype="multipart/form-data" id="distributorForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="dist_code" 
                                           id="dist_code"
                                           value="{{ old('dist_code', $distributor->dist_code) }}" 
