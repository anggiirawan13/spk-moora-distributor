...
@section('title', 'Tambah Skala Bisnis')
            ...
            <div class="card shadow border-0">
                <div class="card-header bg-gradient-primary text-white py-3">
                    <h5 class="mb-0 font-weight-bold">
                        <i class="fas fa-plus-circle mr-2"></i>Tambah Skala Bisnis
                    </h5>
                </div>
                <div class="card-body p-4">
                    <x-alert />

                    <form action="{{ route('business_scale.store') }}" method="POST" id="businessScaleForm">
                        @csrf
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="code" class="font-weight-bold text-dark mb-2">
                                        <i class="fas fa-hashtag text-info mr-2"></i>Kode Skala Bisnis
                                    </label>
                                    <input type="text"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              id="description"
                                              rows="4" 
                                              placeholder="Masukkan deskripsi lengkap tentang skala bisnis ini">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
